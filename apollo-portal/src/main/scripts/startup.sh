...
export JAVA_OPTS="$JAVA_OPTS -Dserver.port=$SERVER_PORT -Desb_url=http://esb.auth.we.com:40001 -Xloggc:$LOG_DIR/heap_trace.txt -XX:HeapDumpPath=$LOG_DIR/HeapDumpOnOutOfMemoryError/"
